...
@keyframes prc_detect-scroll_aZzKG {
  from,
  to {
    --can-scroll: 1;
  }
...
.prc_Dialog_luvDS {
  ...
  @media screen and (prefers-reduced-motion: no-preference) {
    animation: prc_Overlay--motion-scaleFade_ctSnM 0.2s cubic-bezier(0.33, 1, 0.68, 1) 1ms 1 normal none running;
  }
  ...
  &[data-position-regular='left'] {
    ...
    @media screen and (prefers-reduced-motion: no-preference) {
      animation: prc_Overlay--motion-slideInRight_dOTaT 0.25s cubic-bezier(0.33, 1, 0.68, 1) 1ms 1 normal none running;
    }
  }
  ...
  @media (max-width: 767px) {
    ...
    &[data-position-narrow='bottom'] {
      ...
      @media screen and (prefers-reduced-motion: no-preference) {
        animation: prc_Overlay--motion-slideUp_PtiP3 0.25s cubic-bezier(0.33, 1, 0.68, 1) 1ms 1 normal none running;
      }
    }
...
body:has(.prc_Dialog_luvDS.prc_DisableScroll_F6LZa) {
  /* stylelint-disable-next-line primer/spacing */
...
*/
.prc_Dialog_luvDS:has(.prc_Footer_jQfN4) {
  --can-scroll: 0;
  ...
  .prc_DialogOverflowWrapper_oDYJo {
    ...
    animation: prc_detect-scroll_aZzKG;
...
.prc_ActionListItem_uq6I7 {
  ...
  &:has(.prc_TrailingAction_RmUk1 [data-loading='true']):not([aria-disabled='true']) {
  ...
  */
  ...
  & .prc_MultiSelectCheckbox_nK6PJ {
    ...
    &::before {
      ...
      animation: prc_checkmarkOut_XHM8j 80ms cubic-bezier(0.65, 0, 0.35, 1);
...
.prc_ResponsiveCloseButton_Rr-c2 {
  position: absolute;
  top: var(--base-size-8);
...
.prc_Notice_xDTd4:where([data-variant='info']) {
  color: var(--fgColor-accent);
  background-color: var(--bgColor-accent-muted);
  border-color: var(--borderColor-accent-muted);
}

.prc_Notice_xDTd4:where([data-variant='warning']) {
  color: var(--fgColor-attention);
  background-color: var(--bgColor-attention-muted);
  border-color: var(--borderColor-attention-muted);
}

.prc_Notice_xDTd4:where([data-variant='error']) {
...
.prc_MessageTitle_o6PpS {
  font-size: var(--text-body-size-medium);
  font-weight: var(--base-text-weight-semibold);
}

.prc_MessageBody_89DEz {
  font-size: var(--text-body-size-small);
  color: var(--fgColor-muted);
  align-items: center;
...
.prc_CancelSaveButtons_kk2cT {
  display: flex;
  gap: var(--stack-gap-condensed);
  justify-content: flex-end;
}

.prc_ResponsiveCancelSaveButtons_j1--s {
  display: none;
...
.prc_ResponsiveSaveButton_Ooz4Y {
  display: none;
...
.prc_LeadingVisualContainer_YTg7O {
  margin-right: var(--base-size-4);
  /* stylelint-disable-next-line primer/typography */
  line-height: 0;
  flex-shrink: 0;
...
.prc_TextArea_13q4j[data-resize='none'] {
  resize: none;
}

.prc_TextArea_13q4j[data-resize='both'] {
  resize: both;
}

.prc_TextArea_13q4j[data-resize='horizontal'] {
  resize: horizontal;
}

.prc_TextArea_13q4j[data-resize='vertical'] {
  resize: vertical;
}
...
.prc_SideNavLink_HpDo- {
  ...
  .prc_SideNav_aJOh-.prc_SideNavVariant--normal_ZqAVW > & {
    padding: var(--base-size-16);
    color: var(--fgColor-default);
    border: 0;
  ...
  .prc_SideNav_aJOh-.prc_SideNavVariant--lightweight_mcFtR > & {
