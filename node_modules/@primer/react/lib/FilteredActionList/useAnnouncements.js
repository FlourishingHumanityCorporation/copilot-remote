...
const useAnnouncements = (items, listContainerRef, inputRef, t0, t1, message) => {
  ...
  const announce = t4;
  let t5;
  if ($[5] !== announce || $[6] !== inputRef.current || $[7] !== items || $[8] !== listContainerRef || $[9] !== selectedItems || $[10] !== usingRemoveActiveDescendant) {
  ...
  let t6;
  if ($[12] !== announce || $[13] !== inputRef || $[14] !== items || $[15] !== listContainerRef || $[16] !== selectedItems || $[17] !== usingRemoveActiveDescendant) {
    t6 = [listContainerRef, inputRef, items, liveRegion, announce, usingRemoveActiveDescendant, selectedItems];
    $[12] = announce;
    $[13] = inputRef;
    $[14] = items;
    $[15] = listContainerRef;
  ...
  let t7;
  if ($[19] !== announce || $[20] !== isFirstRender || $[21] !== items || $[22] !== listContainerRef || $[23] !== loading || $[24] !== (message === null || message === void 0 ? void 0 : message.description) || $[25] !== (message === null || message === void 0 ? void 0 : message.title) || $[26] !== selectedItems || $[27] !== usingRemoveActiveDescendant) {
    t7 = function announceListUpdates() {
      ...
      if (items.length === 0 && !loading) {
        announce(`${message === null || message === void 0 ? void 0 : message.title}. ${message === null || message === void 0 ? void 0 : message.description}`, {
          delayMs
        });
        return;
      }
  ...
  let t10;
  if ($[29] !== announce || $[30] !== isFirstRender || $[31] !== items || $[32] !== listContainerRef || $[33] !== loading || $[34] !== selectedItems || $[35] !== t8 || $[36] !== t9 || $[37] !== usingRemoveActiveDescendant) {
    t10 = [announce, isFirstRender, items, listContainerRef, liveRegion, usingRemoveActiveDescendant, t8, t9, loading, selectedItems];
    $[29] = announce;
    $[30] = isFirstRender;
    $[31] = items;
    $[32] = listContainerRef;
