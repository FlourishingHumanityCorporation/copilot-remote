...
const Selection = ({
  ...
  if (!selectionVariant) {
    ...
    // warn in development
    if (selected) {
      process.env.NODE_ENV !== "production" ? warning.warning(true, 'For Item to be selected, ActionList or ActionList.Group should have a selectionVariant defined.') : void 0;
    }
    return null;
  }
